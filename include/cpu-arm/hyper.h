...
/// start a thread to start none-secure world
/// \param ns_ints an array containing all none-secure IRQs, 0 ended
/// \param sta_addr none-secure world boot address
void hyper_boot_ns(unsigned *ns_ints, unsigned sta_addr);
